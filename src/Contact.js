  ...
  return (
    <>
      <div className="grid lg:grid-cols-2 mb-5">
        <div className="flex justify-center lg:pl-10 lg:pr-5">
          <div className="flex grid grid-cols-1 lg:grid-cols-2 mb-5 lg:mb-0">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d13248.466985141935!2d151.208038!3d-33.886647!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x6b12ae20520affff%3A0x2b2e36ba68aa4113!2sLEVEL%201%2F457%20Elizabeth%20St%2C%20Surry%20Hills%20NSW%202010%2C%20Australia!5e0!3m2!1sen!2sin!4v1697347345346!5m2!1sen!2sin"
              width="100%"
              className="mb-5 lg:mb-0 map"
              height="450"
              allowfullscreen=""
              loading="lazy"
            ...
            <div className="flex items-center">
              <div className="lg:pl-3 text-gray-600">
                <div className="flex items-center">
                  <svg
                    fill="#0342a6"
                    className="pb-2"
        ...
        <div>
          <div className="px-10 h-full">
            <div className="bg-gray-200 auto p-4 rounded-lg">
