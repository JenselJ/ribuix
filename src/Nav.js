...
const Nav = () => {
  ...
  return (
    <>
      <div className="text-white bg-black h-16 flex items-center justify-center font">
        <div className="flex justify-between nav lg:px-10 xl:px-20 md:px-3">
          <div
          ...
          >
            ...
            >
              <circle
                ...
                cy="16"
                r="14"
                fill="url(#paint0_linear_87_8098)"
              />
              <path
                fill-rule="evenodd"
                clip-rule="evenodd"
              ...
              <defs>
                ...
                >
                  <stop stop-color="#245ec8" />
                  <stop offset="1" stop-color="#06255f" />
                </linearGradient>
              </defs>
            </svg>
            <div className="text font-bold text-3xl ml-2">RIBUIX</div>
          </div>
          <div className="md:hidden pr-3 flex items-center">
            <div className="nav-dropdown-wrapper p-1 rounded">
              <svg
      ...
      <div
        className="mobile-nav md:hidden pl-2 py-2"
        style={{ display: navShow === false ? "none" : "" }}
      >
        <div
          className="nav-button"
          onClick={() => {
